...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:3000"],  # Update to match your frontend port
...
async def summarize_file(file: UploadFile = File(None), words_limit: int = Form(...), text: str = Form(None)):
    try:
